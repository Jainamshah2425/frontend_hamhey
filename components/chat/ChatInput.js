...
// export default function ChatInput({ value, onChange, onSend, onFile, onVoice, disabled, isDark, isConversationStarted }) {
...
//   const containerClasses = isConversationStarted
//   ? "w-full px-2 py-2"
//   : "fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl px-4";
...
export default function ChatInput({ value, onChange, onSend, onFile, onVoice, disabled }) {
  ...
  return (
    <div className="w-full px-6 py-4 bg-white/50 dark:bg-gray-800/50 backdrop-blur-md border-t border-gray-200/50 dark:border-gray-700/50">
      <div className="flex items-center bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 rounded-2xl px-4 py-3 shadow-lg hover:shadow-xl transition-all duration-200 focus-within:ring-2 focus-within:ring-orange-500/20 dark:focus-within:ring-orange-400/20">
        {/* File upload button */}
        <button
          type="button"
        ...
        >
          ...
          <input type="file" ref={fileInputRef} className="hidden" onChange={onFile} disabled={disabled} />
        </button>
